      ...
      <div className="min-h-screen bg-[#F8F7F5]">
        ...
        {cartItemCount > 0 && (
          <button
            ...
            className="fixed bottom-24 right-4 z-40 bg-orange-500 text-white rounded-2xl px-5 py-3 shadow-xl shadow-orange-200 flex items-center gap-2"
          >
            <span className="font-semibold text-sm">{cartItemCount} item{cartItemCount > 1 ? 's' : ''} in cart</span>
